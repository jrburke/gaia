    ...
    return [
      'setup_account_info', 'immediate',
      {
        onPushed: function(cardNode) {
          // Clear the cookie cache, in case this is from after removing all
          // accounts from the app. Do not bother caching the start account
          // setup card since it is fairly simple.
          htmlCache.save('');
        }
      }
    ];
