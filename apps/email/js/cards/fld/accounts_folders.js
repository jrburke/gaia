...
return [
...

  {
     ...
     */
    onClickAccount: function(event, dclickNode) {
      containerListen.handleEvent(dclickNode, (accountNode) => {
    ...
    onClickFolder: function(event, dclickNode) {
      containerListen.handleEvent(dclickNode, (folderNode) => {
