...
return [
  ...
  require('./setup_account_error_mixin'),
  {
    onArgs: function(args) {
      ...
      // Bind this first, before registering event handlers. This allows unit
      // tests to also intercept these functions.
      this.onChangeCompositeSocket = this.onChangeCompositeSocket.bind(this);
      this.onChangeSmtpSocket = this.onChangeSmtpSocket.bind(this);

      composite.socket.addEventListener('change', this.onChangeCompositeSocket);
      smtp.socket.addEventListener('change', this.onChangeSmtpSocket);
