...
return [
  ...
  require('./editor_mixins'),
  {
    createdCallback: function() {
      ...
      var i;
      var addBtns = this.getElementsByClassName('cmp-contact-add');
    ...
    renderAttachments: function() {
      var attachmentsContainer =
        this.getElementsByClassName('cmp-attachment-container')[0];
    ...
    updateAttachmentsSize: function() {
      var attachmentLabel =
        this.getElementsByClassName('cmp-attachment-label')[0];
      var attachmentTotal =
        this.getElementsByClassName('cmp-attachment-total')[0];
      var attachmentsSize =
        this.getElementsByClassName('cmp-attachment-size')[0];
      ...
      if (this.composer.attachments.length === 0) {
        ...
        attachmentsSize.textContent = this.prettyFileSize(totalSize);
      }
