define(function (require) {
  ...
  const messageChunkedPartStream = require('../protocol/message_chunked_part_stream');
  ...
  return {
    downloadParts: co.wrap(function* (ctx, account, messageInfo, parts) {
      ...
      var { folderInfo, uid } = yield this.getFolderAndUidForMesssage(ctx, account, messageInfo);
