define(function (require, exports) {
  ...
  */
   ...
   */
  exports.chewMessageStructure = function (msg, headers, folderIds, flags, convId, maybeUmid, explicitMessageId) {
    if (!headers) {
    ...
    // gmail case
        ...
        var gmailMsgId = parseGmailMsgId(msg['x-gm-msgid']);
  ...
  exports.updateMessageWithFetch = function (message, req, res) {
    ...
    var { contentBlob, snippet } = $mailchew.processMessageContent(res.text, bodyRep.type, bodyRep.isDownloaded, req.createSnippet);
