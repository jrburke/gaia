define(function (require) {
  ...
  const { checkIfAddressListContainsAddress, filterOutIdentity } = require('./address_helpers');
   ...
   *   reply.
   */
  return function replyAllRecipients(sourceRecipients, sourceAuthor, replyAuthor) {
    var rTo = undefined;
