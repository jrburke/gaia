define(function (require) {
  ...
  Composer.prototype = {
    ...
    buildMessage: co.wrap(function* (opts) {
      ...
      var quoteChewedRep = yield asyncFetchBlob(messageInfo.bodyReps[0].contentBlob, 'json');
      var textContent = quoteChewedRep[1];
      if (messageInfo.bodyReps.length === 2) {
        var htmlContent = yield asyncFetchBlob(messageInfo.bodyReps[1].contentBlob, 'text');
