define(function (require) {
  ...
  function bruteForceAttachmentId(existingAttachments) {
    ...
    for (var att of existingAttachments) {
    ...
    var ival = existingAttachments.length;
    var probeStep = 1;
    var relId = undefined;
    do {
  ...
  MessageComposition.prototype = evt.mix({
    ...
    _onMessageChange: function () {
      var wireRep = this._message._wireRep;
    ...
    addAttachment: function (attachmentDef) {
      var relId = bruteForceAttachmentId(this.attachments);
    ...
    removeRecipient: function (bin, addressPair) {
      var recipList = this[bin];
      var idx = recipList.indexOf(addressPair);
      if (idx !== -1) {
