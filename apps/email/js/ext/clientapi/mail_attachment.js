define(function () {
  ...
  MailAttachment.prototype = evt.mix({
    ...
    download: function (callWhenDone, callOnProgress, registerWithDownloadManager) {
      ...
      this._message._api._downloadAttachments(this._message, [], [this._message.attachments.indexOf(this)], [registerWithDownloadManager || false], callWhenDone, callOnProgress);
    }
  });
