define(function () {
  ...
  SyncLifecycle.prototype = {
    ...
    onOverlayChange: function (changedFolderId) {
      ...
      var overlays = this.resolveFolderOverlay(changedFolderId);
      var syncOverlay = overlays ? overlays.sync_refresh || overlays.sync_grow || {} : {};
      ...
      var newSyncActive = !!syncOverlay.status;
      ...
      // cleaned up.)
      var syncFinished = this.syncActive && !newSyncActive;
