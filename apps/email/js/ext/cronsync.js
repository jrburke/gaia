...
define(['logic', './worker-router', './mailslice', './syncbase', './allback', 'module', 'exports'], function (logic, $router, $mailslice, $syncbase, $allback, $module, exports) {
  ...
  CronSync.prototype = {
    ...
    ensureSync: function () {
      ...
      if (!this._completedEnsureSync) return;
    ...
    syncAccount: function (account, doneCallback) {
      ...
      var slice = makeHackedUpSlice(storage, (function (newHeaders) {
        ...
        newHeaders.some(function (header, i) {
          ...
          if (i === $syncbase.CRONSYNC_MAX_MESSAGES_TO_REPORT_PER_ACCOUNT - 1) return true;
        });
        ...
        if (newHeaders.length) {
          ...
          if (account.accountDef.type === 'pop3+smtp') {
            ...
            this._universe.downloadBodies(newHeaders.slice(0, $syncbase.CRONSYNC_MAX_SNIPPETS_TO_FETCH_PER_ACCOUNT), {
    ...
    _checkSyncDone: function () {
      if (!this._completedEnsureSync || !this._syncAccountsDone) return;
