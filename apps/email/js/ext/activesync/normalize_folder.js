define(function (require) {
   ...
   */
  return function normalizeFolder({ idMaker, serverIdToFolderId, folderIdToFolderInfo }, { serverId, parentServerId, displayName, typeNum, forceType }) {
    ...
    if (parentServerId !== '0') {
      ...
      var parentInfo = folderIdToFolderInfo.get(parentFolderId);
    ...
    var useFolderType = folderTypes[typeNum];
    ...
    if (typeNum === $FolderTypes.DefaultInbox) {
      var existingInboxMeta = getFirstFolderWithType(folderIdToFolderInfo, 'inbox');
