define(function (require) {
   ...
   */
  function* enumerateHierarchyChanges(conn, { hierarchySyncKey, emitter }) {

    var w = new $wbxml.Writer('1.3', 1, 'UTF-8');
    w.stag(fh.FolderSync).tag(fh.SyncKey, hierarchySyncKey).etag();
    ...
    e.addEventListener([fh.FolderSync, fh.Changes, [fh.Add, fh.Delete]], function (node) {
      var folderArgs = {};
