define(function (require) {
  ...
  function* createFolder(conn, args) {
    ...
    w.stag(fh.FolderCreate).tag(fh.SyncKey, args.folderSyncKey).tag(fh.ParentId, args.parentFolderServerId).tag(fh.DisplayName, args.folderName).tag(fh.Type, folderType).etag();
