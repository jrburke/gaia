define(function (require) {
   ...
   */
  function* getFolderSyncKey(conn, { folderServerId, filterType }) {
    ...
    w.tag(as.SyncKey, '0').tag(as.CollectionId, folderServerId).stag(as.Options).tag(as.FilterType, filterType).etag().etag().etag().etag();
