define(['./pop3', '../syncbase', 'logic', '../errorutils', 'exports'], function (pop3, syncbase, logic, errorutils, exports) {
  ...
  exports.probeAccount = function (credentials, connInfo) {
    ...
    var conn = new pop3.Pop3Client(opts, function (err) {
      ...
      conn.sendRequest('UIDL', ['1'], false).then(function () {
        conn.sendRequest('TOP', ['1', '0'], true).then(function () {
        ...
        conn.sendRequest('UIDL', [], true).then(function () {
