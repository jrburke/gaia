define(['logic', '../errbackoff', '../composite/incoming', '../errorutils', '../disaster-recovery', 'module', 'require', 'exports'], function (logic, errbackoff, incoming, errorutils, DisasterRecovery, module, require, exports) {
  'use strict';
   ...
   */
  function Pop3Account(universe, compositeAccount, accountId, credentials, connInfo, foldersTOC, dbConn, existingProtoConn) {
