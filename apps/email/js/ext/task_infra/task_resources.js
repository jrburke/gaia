define(function (require) {
  ...
  TaskResources.prototype = {
    ...
    resourcesNoLongerAvailable: function (removedResourceIds) {
      ...
      var removedCount = 0;
      for (var removedResourceId of removedResourceIds) {
      ...
      const nowBlocked = [];
      this._priorities.removeTasksUsingFilter(function (taskThing) {
      ...
      for (var taskThing of nowBlocked) {
    ...
    restoreResourceAfterTimeout: function (resourceId, timeoutMillis) {
      ...
      var timeoutId = setTimeout(function () {
        _this.resourceAvailable(resourceId);
      }, timeoutMillis);
    ...
    whatIsTaskBlockedBy: function (taskId) {
      ...
      const blockedBy = [];
      for (var resource of taskThing.resources) {
