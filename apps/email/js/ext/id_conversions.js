define(function (require) {
  ...
  return {
    ...
    convIdFromMessageId: function (messageId) {
      var idxFirst = messageId.indexOf('.');
      var idxSecond = messageId.indexOf('.', idxFirst + 1);
