...
define(['logic', 'rdcommon/log', '../accountcommon', '../a64', '../accountmixins', '../imap/account', '../pop3/account', '../smtp/account', '../allback', 'exports'], function (logic, $log, $accountcommon, $a64, $acctmixins, $imapacct, $pop3acct, $smtpacct, allback) {
   ...
   */
  function CompositeAccount(universe, accountDef, foldersTOC, dbConn, receiveProtoConn) {
    ...
    this._receivePiece = new PIECE_ACCOUNT_TYPE_TO_CLASS[accountDef.receiveType](universe, this, accountDef.id, accountDef.credentials, accountDef.receiveConnInfo, foldersTOC, dbConn, receiveProtoConn);
