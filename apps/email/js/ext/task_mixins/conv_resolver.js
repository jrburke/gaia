define(function (require) {
  ...
  function* resolveConversationTaskHelper(ctx, msgOrHeaders, accountId, umid) {
    ...
    var idsLackingEntries = [];
    var existingMessageEntry = null;
    for (var [[, headerId], result] of fromDb.headerIdMaps) {
    ...
    var headerIdWrites = new Map();
    // For the entries missing things, they just get the conversation id.
    for (var idLackingEntry of idsLackingEntries) {
